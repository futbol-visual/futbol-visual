...
export const metadata = {
    title: 'Mentoría a Entrenadores - Fútbol Visual',
    description: 'Acelera tu carrera como entrenador con sesiones personalizadas.',
};

export default function MentoriaEntrenadoresPage() {
    return (
        <div className="bg-fv-primary min-h-screen">
            ...
            <div className="relative overflow-hidden bg-fv-primary pb-16 pt-32 sm:pb-24 lg:pb-32 border-b border-neutral-800">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <h1 className="text-4xl sm:text-6xl font-extrabold text-white tracking-tight mb-6">
                        ...
                        <span className="text-fv-accent">como Entrenador.</span>
                    </h1>
            ...
            <div className="py-20 bg-fv-primary">
                <SectionHeader title="¿Cómo trabajamos?" subtitle="Un proceso adaptado a tu día a día en el campo." />
                    ...
                    {[
                        {
                            ...
                            desc: "Reuniones estratégicas 1 a 1, análisis de video e implementación en campo."
                        },
                        {
                            icon: <Users size={32} />,
                            title: "2. Soporte Continuo",
                            desc: "Comunicación constante y acompañamiento directo en tu día a día."
                        },
                        {
                            icon: <Target size={32} />,
                            title: "3. Plan de Acción",
                            desc: "Definición de objetivos a corto y medio plazo con tareas concretas."
                        }
                    ].map((feature, i) => (
            ...
            <div className="bg-fv-accent py-16">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-3xl font-bold text-black mb-4">¿Preparado para dar el gran salto?</h2>
                    <p className="text-black/80 mb-8 text-lg">Hablemos cara a cara y diseñemos tu plan de crecimiento personalizado.</p>
                    <Link
                        href="/contacto"
                        className="inline-block bg-black text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-neutral-800 transition-colors shadow-xl"
                    >
                        Empezar mi Mentoría
                    </Link>
                </div>
